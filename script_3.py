# Create a simplified beginner-friendly example
simple_example_code = '''
"""
...
with open('simple_stock_analyzer.py', 'w') as f:
    f.write(simple_example_code)

print("Created 'simple_stock_analyzer.py' - A beginner-friendly example")
print("This example shows basic stock analysis without requiring Zerodha API")